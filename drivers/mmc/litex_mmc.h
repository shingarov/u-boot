...
#define LITEX_MMC_SDIRQ_PENDING_OFF \
	_next_reg_off(LITEX_MMC_SDIRQ_STATUS_OFF, \
		      LITEX_MMC_SDIRQ_STATUS_SIZE)
#define LITEX_MMC_SDIRQ_ENABLE_OFF \
	_next_reg_off(LITEX_MMC_SDIRQ_PENDING_OFF, \
		      LITEX_MMC_SDIRQ_PENDING_SIZE)
