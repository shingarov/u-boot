...
#endif /* defined(CONFIG_FPGA_ASPEED) || defined(CONFIG_ASPEED_PALLADIUM)" */
...
#endif	/* (SCU_MPLL_FREQ_CFG == SCU_MPLL_FREQ_400M */
#endif  /* defined(CONFIG_FPGA_ASPEED) || defined(CONFIG_ASPEED_PALLADIUM)" */
...
/*
 * Load DDR-PHY configurations table to the PHY registers
 *
...
int ast2600_sdrammc_dg_test(struct dram_info *info, unsigned int datagen,
			    u32 mode)
{
	unsigned int data;
